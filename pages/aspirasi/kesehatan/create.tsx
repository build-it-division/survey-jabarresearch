    ...
    return (
        ...
        <div className="flex flex-col items-center w-full">
            <div className="w-full lg:h-screen flex flex-col lg:flex-row">
                ...
                <div className="mt-5 md:mt-10 flex flex-col justify-center items-center w-full lg:w-6/12">
                    <h1 className="text-xl xl:text-2xl font-semibold text-gray-600 md:mt-10">Untuk Kesehatan Jawa Barat yang Lebih Baik</h1>
                    <form onSubmit={ storePost } className="justify-items-center">
                    <div className="shadow-2xl overflow-hidden sm:rounded-lg h-full">
                    ...
                    <h5 className="text-xs lg:text-xs font-regular text-gray-600 2xl:pb-10 md:mt-5 w-10/12">
